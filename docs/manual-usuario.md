...
- **El premio del frasco** (opcional): al envasar puedes escribirle a tu mermelada **qué te vas a regalar al abrirla** — con tus palabras («un maratón de mi serie», «una tarde libre, sin culpa») y, si quieres, para cuándo la guardas. Cuando decidas abrirla, la app te lo dice de vuelta: **«Te lo ganaste»**, con tus frutas como testigos, y llueven pétalos del color de tu mermelada. El frasco abierto se queda en la alacena para siempre (destapado, con su moño suelto) — lo que se consume es tu permiso en el mundo real, nunca tus memorias. La app jamás bloquea un frasco ni te reclama por abrirlo antes o después: el compromiso es tuyo; la app es la alacena.
