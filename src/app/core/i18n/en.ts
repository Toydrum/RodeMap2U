...
export const EN: Dict = {
  ...
  settings: {
    ...
    deleteForeverBody: 'This is the only action that cannot be undone. Its {count} branches will go with it. Before doing it, we will download an automatic backup of your whole forest — in case you ever miss it.',
