...
export const EN: Dict = {
  ...
  cosecha: {
    ...
    toStove: 'To the stove',
    beat2Title: 'On a low flame',
    beat2Hint: "Stir if you feel like it — it's ready whenever you say.",
    stir: 'Stir 🥄',
    jarIt: 'Jar it',
  ...
  guide: {
    ...
    sections: [
      ...
      },
      {
        icon: '🫙',
        title: 'The preserving house',
        body: "When a branch blooms, the app celebrates big: petals rain across the whole screen, a little card shows the fruit you earned, and the fruit falls from the tree down to its roots. Fruits gather in the harvest jar on your meadow. In The preserving house you can MAKE JAM: pick fruits one by one (one is plenty), simmer them and jar it. The vessel picks itself by your batch — 1 or 2 fruits: a little jar; up to 5: a jar; 6 or more: a grand jar, a mighty jam — and the pot never carries a counter: the rule lives here, not on your work. When jarring you can write it a TREAT in your own words (\"a marathon of my show\", \"a free afternoon, guilt-free\"): when you open it, the app says it back — \"You earned this\" — with your fruits as witnesses, and the opened jar stays with you forever. Nothing is ever spent. You can also do it the OTHER WAY: \"Promise a jar\" creates an empty jar with its treat written up front, and you fill it with the fruits of your tasks. You pick the size by how big the gift feels — a little jar fills with 2 fruits, a jar with 5, a grand jar with 8 — and the bigger the treat, the more fruits it gathers before it seals itself and lets you know. When a branch blooms, the app offers to store it in your jar with one tap; you can also store or take out fruits by hand from The preserving house. You can keep up to three promised jars at once, and let any of them go whenever you like (its fruits return to your harvest). You can also brew a tea: two or three fruits savored sip by sip, leaving no record. The pasitos of a daily path bear no fruit (their celebration is the stone path); the whole path, when it blooms, does.",
      },
      {
        icon: '🍂',
