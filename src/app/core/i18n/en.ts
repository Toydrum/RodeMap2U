  ...
  guide: {
    ...
    sections: [
      ...
      },
      {
        icon: '🫙',
        title: 'The preserving house',
        body: "When a branch blooms, the app celebrates big: petals rain across the whole screen, a little card shows the fruit you earned (\"An apple!\" plus your branch's name), and the fruit falls from the tree down to its roots — each tree bears its own by species. Fruits gather in the harvest jar on your meadow. And in The preserving house you can MAKE JAM: pick fruits one by one (one is plenty), simmer them on a low flame — stirring is optional — and jar it with a name of your own that goes on your pantry shelf. Nothing is ever spent: the fruit only changes home, and tapping a jar shows all its memories. You can also brew a tea: pick two or three fruits and savor them sip by sip — the tea leaves no record, because some joys are for drinking. The pasitos of a daily path bear no fruit (their celebration is the stone path); the whole path, when it blooms, does.",
      },
      {
        icon: '🍂',
