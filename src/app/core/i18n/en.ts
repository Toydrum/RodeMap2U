...
export const EN: Dict = {
  ...
  cosecha: {
    title: 'The harvest',
    subtitle: 'Every branch that blooms leaves its fruit in the jar. Just for looking and savoring — nothing here counts against you.',
    ...
    harvestedOn: 'on {date}',
    total: { one: '{count} fruit in the jar', many: '{count} fruits in the jar' },
    settingsLink: 'The harvest',
    settingsHint: 'The fruit of your bloomed branches, gathered in their jar',
  },
  trail: {
  ...
  guide: {
    ...
    sections: [
      ...
      },
      {
        icon: '🫙',
        title: 'The harvest',
        body: "When a branch blooms, the app celebrates right there: a burst of petals in your tree's colors exactly where you tapped, and a fruit falls from the tree down to its roots — each tree bears its own (apples, pears, cherries… by its species). That fruit lands in the harvest jar, a little glass jar that appears on your meadow with your first fruit. Tapping it opens The harvest: your fruits gathered by month, each with its branch's name and date — tapping one takes you back to that branch. Fruits are memories: they stay even if you later reopen or let go of the branch; nothing is spent and nothing is compared. The pasitos of a daily path bear no fruit (their celebration is each day's stone path); the whole path, when it blooms, leaves its own.",
      },
      {
        icon: '🍂',
