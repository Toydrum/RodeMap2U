...
export const EN: Dict = {
  ...
  whispers: {
    ...
    q4: 'Your forest breathes with you. Passing by for a little moment?',
    q5: 'This moment counts too — what would you keep from it?',
  ...
  checkIn: {
    ...
    noteExpander: 'Leaving yourself a little note?',
    energyLabel: 'How much water is in your watering can today?',
  ...
  almanaque: {
    ...
    piedritaSown: '"{title}" is spinning with you now 🌀',
  ...
  cosecha: {
    ...
    distilledSub: "Distilled in {month}, with this tree's fruits:",
    nextFruit: 'Another fruit',
    enjoyIt: 'Go enjoy it',
    openedToast: 'Jam opened — enjoy it 🫙',
    brindadoToast: 'Toasted — you carry it with you 🍶',
  ...
  account: {
    ...
    newPasswordTitle: 'Time for a password of your own',
  ...
  visita: {
    ...
    readOnlyHint: 'You are visiting: you can look with care — nothing here moves.',
