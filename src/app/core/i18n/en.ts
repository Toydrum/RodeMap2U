...
export const EN: Dict = {
  ...
  ahora: {
    ...
    reasonCaminito: "Today's little path awaits 🌄 — one stone, at your pace",
  ...
  almanaque: {
    ...
    piedritasTitle: "Today's little stones",
    piedritasHint: 'Each little stone is walked whenever you like. Whatever is left wakes up clean tomorrow.',
    piedritasEmpty: "If there's something tiny you like doing often, it has its place here.",
    piedritaAdd: 'Sow a little stone',
    piedritaSheetTitle: 'Sow a little stone',
    ...
    piedritaSown: '"{title}" has its place on the path now 🌄',
    restingOne: '"{title}" rests today — it returns on {day}.',
    restingMany: 'Resting today: {names}. Little paths breathe too.',
  ...
  cosecha: {
    ...
    promise: {
      ...
      filledToast: 'Your jar "{name}" is full! You can make your jam now 🫙',
      makeJam: 'Make the jam',
      makeTitle: 'Make your jam',
      makeHint: 'Your fruits are gathered. Cook them at your pace and jar it.',
  ...
  tree: {
    ...
    repeatAria: 'How often?',
    repeatOnce: 'Once',
    repeatRitual: 'It repeats',
  },
  cadence: {
    aria: "The ritual's rhythm",
    daily: 'Every day',
    days: 'Only these days',
    weekly: 'Once a week',
  ...
  node: {
    ...
    ritualFruitLaw: 'Little stones bear no fruit — the walk is their celebration. The whole ritual, when it blooms, does.',
    nextStepTag: 'next',
