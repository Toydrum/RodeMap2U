    ...
    sections: [
      {
        icon: '🧭',
        title: 'El check-in',
        body: 'Al entrar, la app pregunta "¿Dónde sientes que estás?". Eliges tu clima interno (☀️ a ⛈ — es clima, no calificación), tocas la rama donde sientas que estás, y si quieres te dejas una notita. Todo se puede saltar con "Hoy no quiero responder", sin consecuencia alguna. Para el día a día hay un atajo: «Me siento igual que la última vez» registra tu check-in en un toque y te lleva directo al bosque. Y si tocas algo por error, cada paso tiene su «← Volver». ¿Quieres el ritual de nuevo? En tu bosque vive una rosa de los vientos: «Buscarme en este bosque encantado». Tus check-ins de otros días viven en «Tus huellas» — la huellita 🐾 junto a la rosa de los vientos (también en Ajustes).',
      },
      {
        icon: '🌳',
        title: 'Tu bosque',
      ...
      },
      {
        ...
        body: 'Desde la pestaña Enfoque eliges una rama (o "Solo estar") y una duración; el anillo respira contigo y la sesión te sigue por toda la app — hasta sobrevive si la cierras. Cuando tu tiempo florece, un susurro y una 🌸 en la pestaña te lo cuentan, sin sonidos ni cortes. Al terminar, la app celebra lo que haya sido: estar un ratito es suficiente.',
      },
      {
        icon: '🔒',
        title: 'Tus datos',
