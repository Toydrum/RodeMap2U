...
export const ES = {
  ...
  cosecha: {
    ...
    savedForLabel: '¿Para cuándo la guardas?',
    savedForPlaceholder: '«para cuando termine el semestre»…',
    premioChip: '🎀 Guarda un premio: «{premio}»',
    ...
    promise: {
      ...
      premioAtFill: '🎀 Al llenarlo: «{premio}»',
