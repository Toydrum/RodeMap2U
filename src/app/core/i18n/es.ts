  ...
  guide: {
    ...
    sections: [
      ...
      },
      {
        icon: '🫙',
        title: 'La conservería',
        body: 'Cuando una rama florece, la app lo celebra en grande: llueven pétalos por toda la pantalla, sale una tarjetita con la fruta que ganaste, y en el árbol cae la fruta hasta sus raíces. Las frutas se juntan en el frasco de la cosecha, en tu pradera. En La conservería puedes HACER MERMELADA: eliges frutas una por una (con una alcanza), las cueces a fuego lento y envasas. La vasija se elige sola según tu tanda — 1 o 2 frutas: frasquito; hasta 5: frasco; 6 o más: frascote, una mermelada poderosa — y la olla nunca lleva contador: la regla vive aquí, no en tu trabajo. Al envasar puedes escribirle un PREMIO con tus palabras («un maratón de mi serie», «una tarde libre, sin culpa»): cuando la abras, la app te lo dice de vuelta — «Te lo ganaste» — con tus frutas como testigos, y el frasco abierto se queda contigo para siempre. Nada se gasta jamás. También puedes preparar un té: dos o tres frutas saboreadas sorbo a sorbo, sin dejar registro. Los pasitos de un sendero no dan fruta (su celebración es el caminito); el sendero entero, cuando florece, sí.',
      },
      {
        icon: '🍂',
