...
export const ES = {
  ...
  whispers: {
    ...
    q5: 'Este momento también cuenta — ¿qué guardarías de él?',
  ...
  almanaque: {
    ...
    piedritasTitle: 'Las espirales de hoy',
    piedritasHint: 'Cada espiral gira a tu ritmo. Lo que quede, mañana amanece limpio.',
    ...
    piedritaSown: '«{title}» ya gira contigo 🌀',
    restingOne: '«{title}» descansa hoy — vuelve el {day}.',
    restingMany: 'Hoy descansan: {names}. Los rituales también respiran.',
  ...
  cosecha: {
    ...
    beat1Hint: 'Toca una fruta para pasarla. Con una alcanza — ninguna mermelada es chica.',
    stir: 'Remover 🥄',
    jarIt: 'Envasar',
    beat3Title: 'El nombre de tu frasco',
    ...
    premioLabel: '¿Qué te vas a regalar al abrirla?',
    premioPlaceholder: '«un maratón de mi serie», «una tarde libre, sin culpa»…',
    premioReward: '🎀 Tu premio: «{premio}»',
    // savedFor fue retirado de todos los inputs (0.0.108) — esta línea de
    // lectura queda para frascos viejos que ya guardaban una intención.
    savedForLine: 'La guardas {savedFor}',
    openJam: 'Abrir la mermelada',
    openConfirmTitle: 'Abrir «{name}»',
    openConfirmBody: 'Se abre una vez — y se queda contigo para siempre.',
    notYet: 'Todavía no',
    openIt: 'Abrirla',
    earnedHeadline: 'Te lo ganaste:',
    savorHeadline: 'Para saborear:',
    earnedSub: 'Sellada en {month}, con estas frutas:',
    distilledSub: 'Destilada en {month}, con las frutas de este árbol:',
    nextFruit: 'Otra fruta',
    enjoyIt: 'A disfrutarlo',
    openedToast: 'Mermelada abierta — que la disfrutes 🫙',
    brindadoToast: 'Brindado — te lo llevas contigo 🍶',
    ...
    elixir: {
      title: 'Una despedida',
      body: 'Este árbol dio su fruto y llega a su fin. Cierra el capítulo cuando lo sientas.',
    ...
    jamNames: {
      ...
      arandanos: 'Mermelada de arándanos',
      naranja: 'Mermelada de naranja',
      uvas: 'Mermelada de uva',
      durazno: 'Mermelada de durazno',
      cerezas: 'Mermelada de cereza',
      moras: 'Mermelada de mora',
    },
    jamForest: 'Mermelada del bosque',
    teaTitle: 'Un té de tus frutas',
    teaIntro: 'Nada se mueve de su lugar — solo es para saborear un momento.',
    teaPick: 'Elige una, dos o tres frutas.',
    teaSurprise: 'Que me sorprenda',
    teaBrew: 'Preparar',
    teaSip: 'Otro sorbo',
    teaEnd: 'Gracias por este té',
    fruitCardTitles: {
      manzana: '¡Una manzana!',
      pera: '¡Una pera!',
      arandanos: '¡Arándanos!',
    ...
    fruitCardLine: 'De «{title}» · va camino al frasco',
    pendingShelfTitle: 'Lo que estás llenando',
    promise: {
      door: 'Prometer un frasco',
      limitReached: 'Tres frascos se están llenando contigo — cuando uno cierre, cabe otro',
      title: 'Prometer un frasco',
      beat1Title: '¿Qué te vas a regalar?',
      ...
      beat3Title: '¿Cómo lo llamas?',
      namePlaceholder: 'Mi frasco de…',
      create: 'Prometer',
      fillLine: {
        one: 'Lleva {count} fruta · le caben {cap}',
        many: 'Lleva {count} frutas · le caben {cap}',
      },
      addFruit: 'Guardar una fruta aquí',
      addHint: 'Toca una fruta fresca para guardarla en este frasco.',
      noFresh: 'Ahora mismo no tienes frutas frescas para guardar.',
      removeFruit: 'Sacar del frasco',
      edit: 'Editar',
      editDone: 'Listo',
      release: 'Soltar este frasco',
      releaseConfirmTitle: '¿Soltar «{name}»?',
      releaseConfirmBody: 'Las frutas volverán a tu cosecha y el frasco se irá.',
      releaseConfirm: 'Soltarlo',
      released: 'Frasco soltado — tus frutas volvieron a la cosecha 🍃',
      filledToast: '¡Se llenó tu frasco «{name}»! Ya puedes hacer tu mermelada 🫙',
      makeJam: 'Hacer mermelada',
      makeTitle: 'Hacer tu mermelada',
      makeHint: 'Tus frutas ya están reunidas. Cuécelas a tu ritmo y envasa.',
      storeAsk: '¿La guardas en tu frasco «{name}»?',
      storeAction: 'Guardarla',
      storeChoose: '¿La guardas en un frasco?',
      storeChooseAction: 'Elegir',
      pickerTitle: '¿En cuál frasco la guardas?',
      empty: 'Aún no tienes frascos prometidos.',
    },
  },
  trail: {
    title: 'Tus huellas',
  ...
  forest: {
    ...
    treeNameLabel: '¿Cómo se llama tu árbol?',
    treeNamePlaceholder: 'p. ej. «Aprender guitarra»',
  ...
  tree: {
    ...
    repeatAria: '¿Cada cuándo?',
    repeatOnce: 'Una vez',
    repeatRitual: 'Se repite',
  },
  cadence: {
    aria: 'El ritmo del ritual',
    daily: 'Cada día',
    days: 'Solo estos días',
    weekly: 'Cada semana',
