...
export const ES = {
  ...
  cosecha: {
    ...
    toStove: 'Al fuego',
    beat2Title: 'A fuego lento',
    beat2Hint: 'Remueve si te apetece — ya está lista cuando tú digas.',
    stir: 'Remover 🥄',
    jarIt: 'Envasar',
    ...
    promise: {
      ...
      autoSealToast: 'Se llenó tu frasco «{name}» 🫙',
