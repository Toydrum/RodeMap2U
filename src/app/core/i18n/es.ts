  ...
  guide: {
    ...
    sections: [
      ...
      },
      {
        icon: '🫙',
        title: 'La conservería',
        body: 'Cuando una rama florece, la app lo celebra en grande: llueven pétalos por toda la pantalla, sale una tarjetita con la fruta que ganaste («¡Una manzana!» y el nombre de tu rama), y en el árbol cae la fruta hasta sus raíces — cada árbol da la suya según su especie. Las frutas se juntan en el frasco de la cosecha, en tu pradera. Y en La conservería puedes HACER MERMELADA: eliges frutas una por una (con una alcanza), las cueces a fuego lento — remover es opcional — y envasas un frasco con nombre propio que va a tu alacena. Nada se gasta jamás: la fruta solo cambia de casa, y tocar un frasco te muestra todas sus memorias. También puedes preparar un té: eliges dos o tres frutas y las saboreas sorbo a sorbo — el té no deja registro, porque algunas alegrías son para beberse. Los pasitos de un sendero no dan fruta (su celebración es el caminito); el sendero entero, cuando florece, sí.',
      },
      {
        icon: '🍂',
