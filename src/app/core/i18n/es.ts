...
export const ES = {
  ...
  cosecha: {
    title: 'La cosecha',
    subtitle: 'Cada rama que florece deja su fruta en el frasco. Solo para mirar y saborear — aquí nada se cuenta en contra.',
    jarLabel: 'La cosecha',
    ...
    harvestedOn: 'el {date}',
    total: { one: '{count} fruta en el frasco', many: '{count} frutas en el frasco' },
    settingsLink: 'La cosecha',
    settingsHint: 'Las frutas de tus ramas florecidas, juntitas en su frasco',
  },
  trail: {
    title: 'Tus huellas',
  ...
  guide: {
    ...
    sections: [
      ...
      },
      {
        icon: '🫙',
        title: 'La cosecha',
        body: 'Cuando una rama florece, la app lo celebra ahí mismo: un estallido de pétalos del color de tu árbol justo donde tocaste, y en el árbol cae una fruta hasta sus raíces — cada árbol da la suya (manzanas, peras, cerezas… según su especie). Esa fruta se guarda en el frasco de la cosecha, un frasquito que aparece en tu pradera con tu primera fruta. Tocarlo abre La cosecha: tus frutas juntitas por mes, cada una con el nombre de su rama y su fecha — tocar una te regresa a esa rama. Las frutas son recuerdos: se quedan aunque después reabras o sueltes la rama, nada se gasta y nada se compara. Los pasitos de un sendero no dan fruta (su celebración es el caminito de cada día); el sendero entero, cuando florece, sí deja la suya.',
      },
      {
        icon: '🍂',
