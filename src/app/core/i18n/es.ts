...
export const ES = {
  ...
  ahora: {
    ...
    reasonCaminito: 'El caminito de hoy te espera 🌄 — una piedrita, a tu ritmo',
  ...
  almanaque: {
    ...
    piedritasTitle: 'Las piedritas de hoy',
    piedritasHint: 'Cada piedrita se camina cuando tú quieras. Lo que quede, mañana amanece limpio.',
    piedritasEmpty: 'Si hay algo pequeñito que te gusta hacer seguido, aquí tiene su lugar.',
    piedritaAdd: 'Sembrar una piedrita',
    piedritaSheetTitle: 'Sembrar una piedrita',
    ...
    piedritaSown: '«{title}» ya tiene su lugar en el caminito 🌄',
    restingOne: '«{title}» descansa hoy — vuelve el {day}.',
    restingMany: 'Hoy descansan: {names}. Los caminitos también respiran.',
  ...
  cosecha: {
    ...
    promise: {
      ...
      limitReached: 'Ya tienes 3 promesas llenándose',
  ...
  node: {
    ...
    ritualFruitLaw: 'Las piedritas no dan fruta — su fiesta es el caminito. El ritual entero, cuando florece, sí.',
